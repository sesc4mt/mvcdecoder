 ...
 *
 * Contains:
 *    Common header file for Nokia codec
 *
 */
 ...
 * is not true. In MVC, there is a macro called nccAssert. The macro
 * is defined to 0 for the release version of the software. For the debug
 * version (_DEBUG defined), the macro causes an exit (using nccExit).
 */
#ifdef _DEBUG
