 ...
 *
 * Contains:
 *    Interface for functions handling intra prediction 
 *
 */
...
int iprGetPredLuma16x16(u_int8 predBlk[IPR_NUM_MODES2][MBK_SIZE][MBK_SIZE],
                        int *modeAvail, u_int8 *reco, int picWidth,
                        int mbAvailMap[4]);
//// LOW_COMPLEX_PROF3
...
void iprGetPredLuma4x4(u_int8 predBlk[][BLK_SIZE][MBK_SIZE], int *modeAvail,
                       u_int8 *reco, int picWidth, 
                       int leftMode, int upMode, 
                       int cornersAvail);

void iprGetPredChroma(u_int8 pred[IPR_CHROMA_NUM_MODES][MBK_SIZE/2][2*(MBK_SIZE/2)],
                      int *modeAvail, u_int8 *recoU, u_int8 *recoV, int width,
                      int mbAvailMap[4]);
