 ...
 */
typedef struct _buffering_period_SEI_s
{
	unsigned int seq_parameter_set_id;
	unsigned int initial_cpb_removal_delay;
	unsigned int initial_cpb_removal_delay_offset;

} buffering_period_SEI_s;

/*
 * Buffering Period SEI
 */
typedef struct _picture_timing_SEI_s
{
...
} picture_timing_SEI_s;

int sendBufferingPeriodSEIMessage(bitbuffer_s *bitbuf,buffering_period_SEI_s *bufsei,hrd_parameters_s *hrd, int *bitsNal);
int sendPictureTimingSEIMessage  (bitbuffer_s *bitbuf,picture_timing_SEI_s *bufsei  ,hrd_parameters_s *hrd, int *bitsNal);
