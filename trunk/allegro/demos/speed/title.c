...
void goodbye()
{
   ...
   SCREEN_W = al_get_display_width();
   SCREEN_H = al_get_display_height();
   ...
   stretch_sprite(al_get_backbuffer(), b, SCREEN_W/8+4, SCREEN_H*3/8+4, SCREEN_W*3/4, SCREEN_H/4);

   textout(font, "Happy birthday Arron!", 0, 0, makecol(255, 255, 255));
   stretch_sprite(al_get_backbuffer(), b, SCREEN_W/8, SCREEN_H*3/8, SCREEN_W*3/4, SCREEN_H/4);
