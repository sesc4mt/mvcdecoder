\hypertarget{class_bitstream_data}{
\section{BitstreamData Class Reference}
\label{class_bitstream_data}\index{BitstreamData@{BitstreamData}}
}
...
\index{BitstreamData@{BitstreamData}!BitstreamData@{BitstreamData}}
\index{BitstreamData@{BitstreamData}!BitstreamData@{BitstreamData}}
\subsubsection[{BitstreamData}]{\setlength{\rightskip}{0pt plus 5cm}BitstreamData::BitstreamData ({\bf SlidingWindow} $\ast$ {\em slidingWindow}, \/  const char $\ast$ {\em fileName})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\index{BitstreamData@{BitstreamData}!$\sim$BitstreamData@{$\sim$BitstreamData}}
\index{$\sim$BitstreamData@{$\sim$BitstreamData}!BitstreamData@{BitstreamData}}
\subsubsection[{$\sim$BitstreamData}]{\setlength{\rightskip}{0pt plus 5cm}BitstreamData::$\sim$BitstreamData ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\index{BitstreamData@{BitstreamData}!LoadNextStream@{LoadNextStream}}
\index{LoadNextStream@{LoadNextStream}!BitstreamData@{BitstreamData}}
\subsubsection[{LoadNextStream}]{\setlength{\rightskip}{0pt plus 5cm}bool BitstreamData::LoadNextStream ({\bf uint8\_\-t} $\ast$ {\em stream}, \/  int \& {\em len})\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
...
\index{BitstreamData@{BitstreamData}!ProcessData@{ProcessData}}
\index{ProcessData@{ProcessData}!BitstreamData@{BitstreamData}}
\subsubsection[{ProcessData}]{\setlength{\rightskip}{0pt plus 5cm}void BitstreamData::ProcessData ()\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}
