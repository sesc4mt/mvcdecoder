...
#define ARM_ARCH_V5   50
#define ARM_ARCH_V5E  51
#define ARM_ARCH_V6   60


/* Default ARM Architecture version is v5 */

#ifndef ARM_ARCH_VERSION
#define ARM_ARCH_VERSION  ARM_ARCH_V5
#endif


#define ARM_COMPILER_TYPE_GCC  0
#define ARM_COMPILER_TYPE_ADS  1
#define ARM_COMPILER_TYPE_CCS  2


/* Default compiler is GCC */

#if !defined(ARM_COMPILER_TYPE)
#define ARM_COMPILER_TYPE  ARM_COMPILER_TYPE_GCC
#endif


#if ARM_COMPILER_TYPE == ARM_COMPILER_TYPE_GCC


/*
 * GCC assembler definitions
 */
...
#define CODESEC .text
#define DATASEC .section .rodata

#define GLOBLAB .global
#define EXTLAB .extern

#define ALIGNW .align 2
...
#define LABELDEF(LABEL_NAME) L_ ## LABEL_NAME ## :


#endif  /* ARM_COMPILER_TYPE_GCC */



#if ARM_COMPILER_TYPE == ARM_COMPILER_TYPE_ADS


/*
 * ADS assembler definitions
 */

#define COMPILER_ADS

#define CODESEC AREA |.text|, CODE, READONLY
#define DATASEC AREA |.rdata|, DATA, READONLY
...
#endif /* ARM_COMPILER_TYPE_ADS */



#if ARM_COMPILER_TYPE == ARM_COMPILER_TYPE_CCS


/*
 * CCS assembler definitions
 */
...
#endif  /* ARM_COMPILER_TYPE_CCS */


#endif      /* End of #ifndef ARMASMDEF_H */
