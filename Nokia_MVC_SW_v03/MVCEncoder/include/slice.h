 ...
 *
 * Contains:
 *    Interface for slice layer functions
 *
 */
...
{
  // Interface between slice layer and frame layer
  frmBuf_s    *origBuf;
  frmBuf_s    *recoBuf;
  bitbuffer_s *bitbuf;
  statSlice_s *frmStat;
  ...
  int16 redundantPicCnt;

  // slice encoding structures
  meProfile_s  meProfile;   // control trade-off between coding efficiency & speed in ME
  macroblock_s mb;
} slice_s;
