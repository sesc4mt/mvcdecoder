...
static const int8 dequantCoef[6][16] = {
 ...
 *
 * Function:
 *      Compute approximate 4x4 inverse DCT.
 *
 * Returns:
 *      -
 */
void itrIDCT4x4(int src[4][4])
{
  int tmp[4][4];
  int E;
  int F;
 ...
 *
 * Function:
 *      Compute 4x4 inverse Hadamard transform.
 *
 * Returns:
 *      -
 *
 */
void itrIHada4x4(int src[4][4], int dest[4][4])
{
  int tmp[4][4];
  int E;
  int F;
 ...
 *
 * Function:
 *      Compute 2x2 inverse DCT.
 *
 * Returns:
 *      -
 *
 */
void itrIDCT2x2(int src[2][2], int dest[2][2])
{
  int DDC00 = src[0][0];
  int DDC10 = src[0][1];
  int DDC01 = src[1][0];
 ...
 * Parameters:
 *      src                   Source values
 *      dest                  Dequantized values
 *      qp                    Quantization parameter
 *      n                     Number of values
 *
 * Function:
 *      Dequantize input values.
 *
 * Returns:
 *      -
 *
 */
void itrInvQuant4x4(int *src, int *dest, int qp)
{
  int i;
  ...
  for (i = 0; i < BLK_SIZE*BLK_SIZE; i ++)
    dest[i] = src[i]*dequantCoef[qp_rem][i]<<qp_per;
}
 ...
 *
 * Function:
 *      Dequantize 4x4 DC values.
 *
 * Returns:
 *      -
 *
 */
void itrInvQuantDC4x4(int *src, int *dest, int qp)
{
  int i;
  int qp_per = qpPerTab[qp-MIN_QP];
  int qp_rem = qpRemTab[qp-MIN_QP];
  int deqc = dequantCoef[qp_rem][0]<<qp_per;

  for (i = 0; i < 16; i++)
    dest[i] = (int) (((int32)src[i] * deqc+2) >> 2);
}
 ...
 *
 * Function:
 *      Dequantize 2x2 DC values.
 *
 * Returns:
 *      -
 *
 */
void itrInvQuantDC2x2(int *src, int *dest, int qp)
{
  int i;
  int qp_per = qpPerTab[qp-MIN_QP];
  int qp_rem = qpRemTab[qp-MIN_QP];
